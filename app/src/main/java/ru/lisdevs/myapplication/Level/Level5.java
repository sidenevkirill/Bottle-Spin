                ...
                rotateBottle.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationEnd(Animation animation) {
                        if (theSpinDegrees % 360 > 180){
                            ...
                            Toast.makeText(Level5.this, "Пройдите на 5 секунд с человеком справа от вас", Toast.LENGTH_SHORT).show ();
                        } else {
                            //the right has been chosen
                            Toast.makeText(Level5.this, "Передайте ход другому", Toast.LENGTH_SHORT).show();
                        }
                    }
