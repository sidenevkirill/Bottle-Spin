...
public class Level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lavel3);
                ...
                rotateBottle.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationEnd(Animation animation) {
                        if (theSpinDegrees % 360 > 180){
                            ...
                            Toast.makeText(Level3.this, "Пройдите на 5 секунд с человеком справа от вас", Toast.LENGTH_SHORT).show ();
                        } else {
                            //the right has been chosen
                            Toast.makeText(Level3.this, "Передайте ход другому", Toast.LENGTH_SHORT).show();
                        }
                    }
